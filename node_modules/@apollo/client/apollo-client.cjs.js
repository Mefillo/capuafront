                ...
                execute = function (selection) { return tslib.__awaiter(_this, void 0, void 0, function () {
                    ...
                    return tslib.__generator(this, function (_a) {
                        ...
                        if (isInlineFragment(selection)) {
                            ...
                            process.env.NODE_ENV === "production" ? tsInvariant.invariant(fragment, 19) : tsInvariant.invariant(fragment, "No fragment named " + selection.name.value);
                        }
...
var QueryManager = (function () {
    ...
    QueryManager.prototype.stop = function () {
        ...
        this.cancelPendingFetches(process.env.NODE_ENV === "production" ? new tsInvariant.InvariantError(11) : new tsInvariant.InvariantError('QueryManager stopped while query was in flight'));
    };
    ...
    QueryManager.prototype.query = function (options) {
        var _this = this;
        process.env.NODE_ENV === "production" ? tsInvariant.invariant(options.query, 14) : tsInvariant.invariant(options.query, 'query option is required. You must specify your GraphQL document ' +
            'in the query option.');
        process.env.NODE_ENV === "production" ? tsInvariant.invariant(options.query.kind === 'Document', 15) : tsInvariant.invariant(options.query.kind === 'Document', 'You must wrap the query string in a "gql" tag.');
        process.env.NODE_ENV === "production" ? tsInvariant.invariant(!options.returnPartialData, 16) : tsInvariant.invariant(!options.returnPartialData, 'returnPartialData option only supported on watchQuery.');
        process.env.NODE_ENV === "production" ? tsInvariant.invariant(!options.pollInterval, 17) : tsInvariant.invariant(!options.pollInterval, 'pollInterval option only supported on watchQuery.');
    ...
    QueryManager.prototype.clearStore = function () {
        this.cancelPendingFetches(process.env.NODE_ENV === "production" ? new tsInvariant.InvariantError(18) : new tsInvariant.InvariantError('Store reset while query was in flight (not completed in link chain)'));
...
var Policies = (function () {
    ...
    Policies.prototype.setRootTypename = function (which, typename) {
        ...
        if (typename !== old) {
            process.env.NODE_ENV === "production" ? tsInvariant.invariant(!old || old === which, 31) : tsInvariant.invariant(!old || old === which, "Cannot change root " + which + " __typename more than once");
    ...
    return {
        ...
        mergeObjects: function (existing, incoming) {
            if (Array.isArray(existing) || Array.isArray(incoming)) {
                throw process.env.NODE_ENV === "production" ? new tsInvariant.InvariantError(32) : new tsInvariant.InvariantError("Cannot automatically merge arrays");
            }
...
function computeKeyObject(response, specifier, aliasMap) {
    ...
    specifier.forEach(function (s) {
        if (Array.isArray(s)) {
            ...
            process.env.NODE_ENV === "production" ? tsInvariant.invariant(hasOwn.call(response, responseName), 33) : tsInvariant.invariant(hasOwn.call(response, responseName), "Missing field '" + responseName + "' while computing key fields");
...
var ApolloProvider = function (_a) {
    ...
    return React__default.createElement(ApolloContext.Consumer, null, function (context) {
        ...
        process.env.NODE_ENV === "production" ? tsInvariant.invariant(context.client, 4) : tsInvariant.invariant(context.client, 'ApolloProvider was not passed a client instance. Make ' +
...
var ApolloConsumer = function (props) {
    var ApolloContext = getApolloContext();
    return React__default.createElement(ApolloContext.Consumer, null, function (context) {
        process.env.NODE_ENV === "production" ? tsInvariant.invariant(context && context.client, 5) : tsInvariant.invariant(context && context.client, 'Could not find "client" in the context of ApolloConsumer. ' +
...
function useApolloClient() {
    ...
    process.env.NODE_ENV === "production" ? tsInvariant.invariant(client, 6) : tsInvariant.invariant(client, 'No Apollo Client instance can be found. Please ensure that you ' +
